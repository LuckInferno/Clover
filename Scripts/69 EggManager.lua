...
EGGMAN.snowyboy = function() if not INCUBPATION_ERIOD(12,20, 12,31)() and not zxcvbn then return else local z = zxcvbn and color("#ffdbff") or color("#f5f7fa") local t=Def.ActorFrame{} for i=1,150 do t[#t+1]=Def.Quad{BaseZoomX=1+math.random(8),BaseZoomY=1+math.random(8),
